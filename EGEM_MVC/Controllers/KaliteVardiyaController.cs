...
{
    public class KaliteVardiyaController : Controller
    {
        ...
        public ActionResult KaliteVar(int? Page_No)
        {
            var students = from stu in db.EGEM_KALITE_VARDIYA select stu;
        ...
        public ActionResult KaliteVardetay(int? id)
        {
            List<EGEM_KALITE_VARDIYA> studentList = db.EGEM_KALITE_VARDIYA.ToList();
